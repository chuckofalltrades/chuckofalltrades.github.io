	...
	<xsl:template match="/">
		<html xmlns="http://www.w3.org/1999/xhtml" lang="en-US">
			<head>
				...
				<xsl:variable name="tableMinWidth" select="'727'"/><xsl:variable name="colorMain" select="'#222222'"/><xsl:variable name="colorAccent" select="'#00a0d2'"/><xsl:variable name="relativeFontColor" select="'#ffffff'"/><title>XML Sitemap &#x2d; Charles Palmer</title>
...
<link rel="icon" href="https://charles-of-all-trades.local/wp-content/uploads/2024/06/cropped-Charles-Headshot-2-Circle-32x32.png" sizes="32x32" />
<link rel="icon" href="https://charles-of-all-trades.local/wp-content/uploads/2024/06/cropped-Charles-Headshot-2-Circle-192x192.png" sizes="192x192" />
<link rel="apple-touch-icon" href="https://charles-of-all-trades.local/wp-content/uploads/2024/06/cropped-Charles-Headshot-2-Circle-180x180.png" />
<meta name="msapplication-TileImage" content="https://charles-of-all-trades.local/wp-content/uploads/2024/06/cropped-Charles-Headshot-2-Circle-270x270.png" />
			</head>
			<body class="ltr">
				<div id="description">
					<div class="wrap">
						<a href="https://charles-of-all-trades.local"><h1><img src="https://charles-of-all-trades.local/wp-content/uploads/2024/06/cropped-Charles-Headshot-2-Circle-32x32.png" width="29" height="29" />Charles Palmer — XML Sitemap</h1></a>
<p>
